...
""",
    ...
    chat_parser.add_argument(
        "--provider",
        # No `choices=` here: built-in providers, claude-cli, and user-defined
        # providers from config.yaml `providers:` are valid values; runtime
        # resolution handles validation/error reporting consistently with the
        # top-level `--provider` flag.
        default=None,
